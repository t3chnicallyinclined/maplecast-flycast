...
so the browser runs real MVC2 SH-4 game code (no ROM, no emulator). Build:
    ...
    python3 gen_one.py $BANK/bank04.asm 38056 38097 knockback_4f974 38197:38205
    ...
    zig cc -target wasm32-freestanding -nostdlib -Wl,--no-entry -Wl,--export-dynamic -Os \
      -I_wasmstub -I. exec_demo.c gen_rng.c gen_accum_3015c.c gen_nrand_e750.c gen_btnmask_2d1c0.c gen_knockback_4f974.c \
      -o exec_demo.wasm
