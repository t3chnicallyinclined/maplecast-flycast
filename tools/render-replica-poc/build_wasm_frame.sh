...
EXPORTS='["_render_frame_ta","_render_frame_body_count","_render_frame_sat_count","_render_frame_quad_count","_render_frame_quad_sels","_render_frame_quad_gfx1s","_render_frame_quad_colrow","_render_frame_quad_mirror","_render_frame_set_body_tcws","_malloc","_free"]'
