...
[ -n "$MAPLECAST_NUDGE_SERVER" ] && export MAPLECAST_NUDGE_SERVER
[ -n "$MAPLECAST_NUDGE_CLIENT" ] && export MAPLECAST_NUDGE_CLIENT
[ -n "$MAPLECAST_LOOKUP_TEST" ] && export MAPLECAST_LOOKUP_TEST
